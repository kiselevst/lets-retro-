...
--
-- Осознанное упрощение для MVP: без Supabase Auth у Postgres нет способа
-- проверить, "кто" делает запрос — anon-ключ у всех участников один и тот же.
...
-- то же самое доверие, но теперь явно описанное в БД.
